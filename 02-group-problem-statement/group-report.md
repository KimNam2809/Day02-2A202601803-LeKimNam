...
## Thành viên nhóm & Phân vai trò

| STT | Họ và tên | Mã học viên | Vai trò | Nhiệm vụ chính |
|-----|-----------|-------------|---------|----------------|
| 1   | Nguyễn Hoài Nam | 2A202602016 | 🎯 Facilitator (Lead) | Điều phối thảo luận, giữ timeline, chốt quyết định khi nhóm bế tắc |
| 2   | Lê Kim Nam | 2A202601803 | 🎯 Facilitator (Co-lead) | Hỗ trợ điều phối, theo dõi checklist nộp bài, đảm bảo đủ deliverable |
| 3   | Nguyễn Thanh Tùng | 2A202601871 | 💡 Problem Champion | Bảo vệ & phản biện candidate problem được chọn, giữ focus vào bottleneck thật |
| 4   | Phan Trần Tường Vy | 2A202601701 | 💡 Problem Champion | Phản biện Problem Statement, đảm bảo actor/metric/boundary đủ cụ thể |
| 5   | Vũ Ngọc Thiện | 2A202601793 | 🔄 Workflow Designer | Vẽ current workflow chi tiết (bước, actor, input/output, thời gian) |
| 6   | Nguyễn Quốc Hiệu | 2A202601627 | 🔄 Workflow Designer | Vẽ future workflow (AI intervention point, human boundary, fallback) |
| 7   | Nguyễn Duy Lâm | 2A202601073 | 🔄 Workflow Designer | So sánh before/after, tính impact metric, vẽ sơ đồ Mermaid/ASCII |
| 8   | Nguyễn Khắc Huy | 2A202602036 | 🔍 Researcher | Tìm existing solutions/tools (Intercom, n8n, Zendesk...), ghi link nguồn |
| 9   | Nguyễn Minh Hoàng | 2A202601609 | 🔍 Researcher | Tìm case study/pattern tương tự, phân tích điểm mạnh/khoảng trống |
| 10  | Nguyễn Tuấn Anh | 2A202601775 | ✅ Validator | Quick interview TA/học viên, thu thập dấu hiệu thật (thời gian, tần suất) |
| 11  | Trần Đoàn Quang Vũ | 2A202601999 | ✅ Validator | Quan sát Discord ticket, đo first response time, đếm re-open rate |
| 12  | Lê Mạnh Cương | 2A202601137 | ✅ Validator | Tổng hợp kết quả validation, xác nhận/phản bác giả định nhóm |
| 13  | Lê Ngọc Khánh | 2A202601487 | ⚖️ AI Evaluator | So sánh Rule / Workflow / Agent, lập luận chọn/không chọn từng mức |
| 14  | Đoàn Ngọc Chung | 2A202601869 | ⚖️ AI Evaluator (Devil's Advocate) | Phản biện quyết định AI: "Có thật sự cần AI không?", challenge nhóm |
| 15  | Nguyễn Minh Hiếu | 2A202601685 | 📝 Scribe & Presenter | Ghi chép thảo luận, soạn group report, đảm bảo format đúng yêu cầu |
| 16  | Bùi Đức Lân | 2A202602037 | 📝 Scribe & Presenter | Chuẩn bị slides/trình bày nếu cần, review report cuối trước khi nộp |

### Mô tả vai trò

| Vai trò | Biểu tượng | Số người | Tham gia chính ở Phase | Trách nhiệm cốt lõi |
|---------|-----------|----------|------------------------|---------------------|
| **Facilitator** | 🎯 | 2 | Tất cả phases | Điều phối, giữ timeline, chốt quyết định, đảm bảo mọi người đóng góp |
| **Problem Champion** | 💡 | 2 | Phase 3, 5, 6 | Bảo vệ problem, phản biện PS, đảm bảo actor/metric/boundary rõ ràng |
| **Workflow Designer** | 🔄 | 3 | Phase 5 | Vẽ workflow trước/sau, xác định bottleneck, tính before/after impact |
| **Researcher** | 🔍 | 2 | Phase 4.2 | Tìm tool/case/pattern đã có, ghi nguồn, phân tích khoảng trống |
| **Validator** | ✅ | 3 | Phase 4.1 | Interview/survey, thu thập evidence, xác nhận/phản bác giả định |
| **AI Evaluator** | ⚖️ | 2 | Phase 6 | So sánh Rule/Workflow/Agent, phản biện quyết định AI, đưa ra Go/Not Yet/No-Go |
| **Scribe & Presenter** | 📝 | 2 | Tất cả phases | Ghi chép, soạn report, review format, trình bày kết quả |
